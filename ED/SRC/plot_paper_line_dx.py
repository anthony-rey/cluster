...
dataFolder = "../DATA/LINE_DX"
graphsFolder = "../GRAPHS/LINE_DX"
...
for l in range(len(lam)):
	for i in range(4):
		...
		ax[i].set_title(fr"$2N(E_{{{i+1}}} - E_{{{i}}})$", pad=10, fontsize=18)
	...
	ax[3].legend(loc="center left", bbox_to_anchor=(1, 0.5), borderaxespad=1, ncol=1, labelspacing=0.8, columnspacing=0.8, handletextpad=0.6, handlelength=1.8).set_zorder(200)
