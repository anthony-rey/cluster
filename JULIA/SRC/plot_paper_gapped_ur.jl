		...
		# ------------------------------
			...
			if plot_spins
				...
				for j=1:k
					...
					ax.plot(range(2, length(mZSPT)+1), mZSPT, color=colors[7], label=latexstring(L"$\langle \widehat{Z}^{\,}_{j-1} \widehat{Z}^{\,}_{j} \widehat{Z}^{\,}_{j+1} \rangle$"), zorder=100)
...
if plot_scaling_en
	...
	for t=length(theta):-1:1
		...
		PyPlot.rc("axes", prop_cycle=cycler.cycler(marker=[".", "+", "x"], markersize=2 .*[10, 10, 7.5], markeredgewidth=2 .*[1, 1.5, 1.5], color=cmap(numpy.linspace(0, 1, 3))))
		...
		for k=1:nE-1
			if !(k in [2,3,4,5,6,7])
				...
				if k==1
					p, = ax_gaps[s].plot(1 ./Ns, diffsNs[:, l, t, k], linewidth=0, zorder=-90+k, label=latexstring(L"$E^{\,}_{7}-E^{\,}_{0}$"))
				else
...
ax_gaps[1].set_title(latexstring(L"(a) \ OBC, \ $\theta=\pi/2,\ \lambda=1$"), pad=8)
ax_gaps[2].set_title(latexstring(L"(b) \ OBC, \ $\theta=19\pi/20,\ \lambda=9/10$"), pad=8)
...
# ax[1].annotate("(a)", xy=(0.87, 0.45), xycoords="axes fraction", fontsize=16)
# ax[2].annotate("(b)", xy=(0.87, 0.45), xycoords="axes fraction", fontsize=16)
...
p, = ax_spins_corner[1].plot(range(2, length(mX)+1), mX, markersize=3, lw=0.8, marker="x", color=colors[1], label=latexstring(L"$\langle \widehat{Z}^{\,}_{j-1} \, \widehat{X}^{\,}_{j} \, \widehat{Z}^{\,}_{j+1} \rangle^{\,}_{\Psi}$"), zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
push!(ps, p)
p, = ax_spins_corner[1].plot(range(2, length(mY)+1), mY, markersize=4, lw=0.8, markeredgewidth=2, marker=2, color=colors[4], label=latexstring(L"$\langle \widehat{Z}^{\,}_{j-1} \, \widehat{Y}^{\,}_{j} \, \widehat{Z}^{\,}_{j+1} \rangle^{\,}_{\Psi}$"), zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
push!(ps, p)
p, = ax_spins_corner[1].plot(range(2, length(mZ)+1), mZ, markersize=4, lw=0.8, markeredgewidth=2, marker=3, color=colors[7], label=latexstring(L"$\langle \widehat{Z}^{\,}_{j-1} \, \widehat{Z}^{\,}_{j} \, \widehat{Z}^{\,}_{j+1} \rangle^{\,}_{\Psi}$"), zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
push!(ps, p)
...
p, = ax_spins_corner[3].plot(range(2, length(mX)+1), mX, markersize=3, lw=0.8, marker="x", color=colors[1], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
p, = ax_spins_corner[3].plot(range(2, length(mY)+1), mY,  markersize=4, lw=0.8, markeredgewidth=2, marker=2, color=colors[4], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
p, = ax_spins_corner[3].plot(range(2, length(mZ)+1), mZ, markersize=4, lw=0.8, markeredgewidth=2, marker=3, color=colors[7], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
...
ax_spins_corner[1].set_title(latexstring(L"(a) \ $E^{\,}_{0}$, \ OBC, \ $\theta=\pi/2,\ \lambda=1$"), pad=8)
ax_spins_corner[3].set_title(latexstring(L"(b) \ $E^{\,}_{8}$, \ OBC, \ $\theta=\pi/2,\ \lambda=1$"), pad=8)
...
# ax_spins[2].annotate("(e)", xy=(1.01, 0.45), xycoords="axes fraction", fontsize=16)
...
p, = ax_spins_phase[1].plot(range(2, length(mX)+1), mX, markersize=3, lw=0.8, marker="x", color=colors[1], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
p, = ax_spins_phase[1].plot(range(2, length(mY)+1), mY, markersize=4, lw=0.8, markeredgewidth=2, marker=2, color=colors[4], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
p, = ax_spins_phase[1].plot(range(2, length(mZ)+1), mZ, markersize=4, lw=0.8, markeredgewidth=2, marker=3, color=colors[7], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
...
p, = ax_spins_phase[3].plot(range(2, length(mX)+1), mX, markersize=3, lw=0.8, marker="x", color=colors[1], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
p, = ax_spins_phase[3].plot(range(2, length(mY)+1), mY,  markersize=4, lw=0.8, markeredgewidth=2, marker=2, color=colors[4], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
p, = ax_spins_phase[3].plot(range(2, length(mZ)+1), mZ, markersize=4, lw=0.8, markeredgewidth=2, marker=3, color=colors[7], zorder=100)
p.set_marker(matplotlib.markers.MarkerStyle(p.get_marker(), capstyle="round"))
...
ax_spins_phase[1].set_title(latexstring(L"(c) \ $E^{\,}_{0}$, \ OBC, \ $\theta=19\pi/20,\ \lambda=9/10$"), pad=8)
ax_spins_phase[3].set_title(latexstring(L"(d) \ $E^{\,}_{8}$, \ OBC, \ $\theta=19\pi/20,\ \lambda=9/10$"), pad=8)
