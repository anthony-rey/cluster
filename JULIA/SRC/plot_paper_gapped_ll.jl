...
ax_gaps[1].set_title(latexstring(L"(a) \ OBC, \ $\theta=0,\ \lambda=0$"), pad=8)
ax_gaps[2].set_title(latexstring(L"(b) \ OBC, \ $\theta=\pi/20,\ \lambda=1/10$"), pad=8)
...
ax_spins[1].set_title(latexstring(L"(a) \ $E^{\,}_{0}$, \ OBC, \ $\theta=0,\ \lambda=0$"), pad=8)
ax_spins[2].set_title(latexstring(L"(c) \ $E^{\,}_{2}$, \ OBC, \ $\theta=0,\ \lambda=0$"), pad=8)
...
ax_spins[3].set_title(latexstring(L"(b) \ $E^{\,}_{0}$, \ OBC, \ $\theta=\pi/20,\ \lambda=1/10$"), pad=8)
ax_spins[4].set_title(latexstring(L"(d) \ $E^{\,}_{2}$, \ OBC, \ $\theta=\pi/20,\ \lambda=1/10$"), pad=8)
